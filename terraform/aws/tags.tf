...
variable "project_tags" {
  ...
  type        = map(string)
  default = {
    key = "mnc8_EDB_PREREQS_POSTGRES_AWS"
  }
}

variable "project_tag" {
  type    = string
  default = "mnc8_EDB_PREREQS_POSTGRES_AWS_DEPLOYMENT"
}
...
variable "name" {
  ...
  type        = string
  default     = "mnc8_EDB_PREREQS_POSTGRES_AWS"
}
...
variable "vpc_tag" {
  default = "mnc8_EDB_PREREQS_POSTGRES_VPC"
}

# Subnets
variable "public_subnet_tag" {
  default = "mnc8_EDB_PREREQS_POSTGRES_PUBLIC_SUBNET"
}
