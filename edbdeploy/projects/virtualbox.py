...
class VirtualBoxProject(Project):
    ...
    def hook_post_configure(self, env):
        ...
        # Copy VirutalBox Mech Config File into project dir.
        self._copy_virtualbox_configfiles()
    ...
    def _copy_virtualbox_configfiles(self):
        """
        Copy reference architecture Mech Config file into project directory.
        """
        # Un-comment the self.virtualbox_share_path once the entire commit has been
        # completed
