...
class AzureAKSProject(Project):
    def __init__(self, name, env, bin_path=None):
        super(AzureAKSProject, self).__init__('azure', name, env, bin_path)
    ...
    def _build_terraform_vars(self, env):
        ...
        """
        Build Terraform variable for Azure AKS Cluster provisioning
        """
    ...
    def _check_instance_image(self, env):
        ...
        """
        Check Azure instance type and image id availability in specified region.
        """
