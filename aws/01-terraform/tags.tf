...
variable "project_tags" {
  ...
  type        = map(string)
  default = {
    key = "demo_EDB_PREREQS_POSTGRES_AWS"
  }
}

variable "project_tag" {
  type    = string
  default = "demo_EDB_PREREQS_POSTGRES_AWS_DEPLOYMENT"
}
...
variable "name" {
  ...
  type        = string
  default     = "demo_EDB_PREREQS_POSTGRES_AWS"
}
...
variable "vpc_tag" {
  default = "demo_EDB_PREREQS_POSTGRES_VPC"
}

# Subnets
variable "public_subnet_tag" {
  default = "demo_EDB_PREREQS_POSTGRES_PUBLIC_SUBNET"
}
